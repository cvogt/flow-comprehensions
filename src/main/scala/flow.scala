...
class FlowMacros(val c: blackbox.Context){
  ...
  class Transformations(
    ...
    // Puts things into form for the extractions phase.
    ...
    // Turn extractions info flatMaps
